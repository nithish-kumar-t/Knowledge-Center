...
public class AddServiceTest {
    ...
    public void testAddDocumentMethod() throws Exception {
        ...
        Document[] response = createService.addNewDocument(documents , category.getName(), knowledgeBase.getKnowledgeId(), author.getAuthId());
        assertEquals(response[0].getCategory(), category.getName());
    }
