...
public class Add {
    ...
    @PostMapping(path ="/{id}/{knowledgeBaseId}/addNewCategory")
    ...
    @PostMapping(path = "/{id}/{knowledgeBaseId}/{categoryName}/addNewDocument")
    public Document[] addNewDocument(@RequestBody Document[] document,
                                   @PathVariable String categoryName,
                                   @PathVariable String knowledgeBaseId,
                                   @PathVariable(name = "id") String authId) throws Exception {
        return createService.addNewDocument(document, categoryName, knowledgeBaseId, authId);
    }
